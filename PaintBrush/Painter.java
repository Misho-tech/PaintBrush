	...
	public class Painter extends Applet{
		...
		private Button redButton, greenButton, blueButton, blackButton, whiteButton, yellowButton,orangeButton,darkgraybutton;
		...
		public void init(){
			...
			darkgraybutton = new Button("Dark Gray");
			...
			clearAllButton.setBackground(Color.CYAN);
